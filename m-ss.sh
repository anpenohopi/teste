...
Modify_config_password(){
	...
	if [[ -z "${match_edit}" ]]; then
		echo -e "${Error} User password modification failed ${Green_font_prefix}[Port: ${ssr_port}]${Font_color_suffix} "
        echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
        echo ""
        read -n 1 -s -r -p "Press any key to back on menu"
        m-ss
	else
		echo -e "${Info} User password modified successfully ${Green_font_prefix}[Port: ${ssr_port}]${Font_color_suffix}"
        echo -e "(It may take about 10 seconds to apply the latest configuration)"
        echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
        echo ""
        read -n 1 -s -r -p "Press any key to back on menu"
        m-ss
...
centos_View_user_connection_info(){
	...
	[[ -z ${user_info} ]] && echo -e "${Error} Didn't find the user, please check again !" && read -n 1 -s -r -p "Press any key to back on menu" && m-ss
	...
	echo -e "The total number of users: ${Green_font_prefix} "${user_total}" ${Font_color_suffix} ，The total number of linked IPs: ${Green_font_prefix} "${IP_total}" ${Font_color_suffix} "
...
View_user_connection_info(){
	SSR_installation_status
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\E[0;100;33m  • SSR CONNECTION INFORMATION •   \E[0m"
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
List_port_user(){
    ...
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\E[0;100;33m   • SSR ACCOUNT INFORMATION •     \E[0m"
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
	echo && echo -e "Total of all users ${Green_font_prefix} "${user_total}" ${Font_color_suffix}"
	echo -e ${user_list_all}
}
Manually_Modify_Config(){
    ...
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\E[0;100;33m      • MODIFY SSR CONFIG •        \E[0m"
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo ""
...
Clear_transfer(){
	SSR_installation_status
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\E[0;100;33m      • CLEAR TRAFFIC SSR •        \E[0m"
    echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"    
 ...
 ${Green_font_prefix}5.${Font_color_suffix}  Modify the timing of all user traffic" && echo
	...
	[[ -z "${ssr_modify}" ]] && echo "cancelled..." && echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" && echo "" && read -n 1 -s -r -p "Press any key to back on menu" && m-ss
...
View_Log(){
	...
	echo && echo -e "${Tip} Click ${Red_font_prefix}Ctrl+C then Q ${Font_color_suffix}To Stop Displaying logs " 
	echo -ne "${Tip} If you understood press any key now " && read -n 1 -s -r
	less +F ${ssr_log_file}
	m-ss
}
Update_Shell(){
	echo -e "The current version is [$ {sh_ver}], start checking for the latest version ... "
	sh_new_ver=$(wget -q --no-check-certificate -qO- "https://raw.githubusercontent.com/hybtoy/ssrrmu/master/ssrrmu.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
	[[ -z ${sh_new_ver} ]] && sh_new_ver=$(wget -q --no-check-certificate -qO- "https://raw.githubusercontent.com/hybtoy/ssrrmu/master/ssrrmu.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
...
chck_pid(){
	PID=`ps -ef |grep -v grep | grep shadowsocks-libev |awk '{print $2}'`
}
menu_sts(){
...
clear 
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\E[0;100;33m        • SS & SSR MENU •          \E[0m"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
menu_sts
echo -e "
Shadowsocks Menu
[\e[36m•1\e[0m] Create Shadowsocks Account
[\e[36m•2\e[0m] Delete Shadowsocks Account
[\e[36m•3\e[0m] Renew Shadowsocks Account
[\e[36m•4\e[0m] Check User Login Shadowsocks

\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
menu_status
echo -e "
Shadowsocks-R Menu
[\e[36m•5\e[0m] Create SS-R Account
[\e[36m•6\e[0m] Deleting SS-R Account
[\e[36m•7\e[0m] Extending SS-R Account Active Life

[\e[36m•8\e[0m] Check the account information SSR
[\e[36m•9\e[0m] Display the connection information SSR
[\e[36m10\e[0m] Change Password User SSR
[\e[36m11\e[0m] Manually Modify User Configuration SSR
[\e[36m12\e[0m] Clear The Used Traffic SSR
[\e[36m13\e[0m] Start ShadowsocksR 
[\e[36m14\e[0m] Stop ShadowsocksR
[\e[36m15\e[0m] Restart ShadowsocksR
[\e[36m16\e[0m] Cek ShadowsocksR log

[\e[31m•0\e[0m] \e[31mBACK TO MENU\033[0m"
echo ""
